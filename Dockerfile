FROM ubuntu:19.04
WORKDIR /root
RUN apt-get update -y && apt-get install unzip build-essential git
...
RUN git clone git@github.com:vultr/terraform-provider-vultr.git
